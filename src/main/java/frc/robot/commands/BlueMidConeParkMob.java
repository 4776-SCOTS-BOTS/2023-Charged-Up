...
public class BlueMidConeParkMob extends SequentialCommandGroup {
  /** Creates a new CubeAndLeaveAuto. */
  DataLog log = DataLogManager.getLog();
  StringLogEntry statusLog = new StringLogEntry(log, "/my/status");

  public BlueMidConeParkMob(DriveSubsystem drive, Arm arm, Gripper gripper, Intake intake) {
    Pose2d startPose = new Pose2d(Units.inchesToMeters(75), Units.inchesToMeters(86.0), new Rotation2d(0));
    Pose2d turnPose = new Pose2d(Units.inchesToMeters(275), Units.inchesToMeters(108), new Rotation2d(Math.toRadians(0)));
    ...
    Pose2d balancePose = new Pose2d(Units.inchesToMeters(155), Units.inchesToMeters(108), new Rotation2d(Math.toRadians(0)));
    ...
    RectangularRegionConstraint rampConstraint = new RectangularRegionConstraint(new Translation2d(4, 1.524),
    ...
    //     config);
        ...
        Trajectory driveToCubeTraj = TrajectoryGenerator.generateTrajectory(
            ...
            List.of(new Translation2d(Units.inchesToMeters(88), Units.inchesToMeters(100)),
                new Translation2d(Units.inchesToMeters(165), Units.inchesToMeters(108))),
            // End end at the cube, facing forward
            turnPose,
            config);
    ...
    Trajectory driveToBalanceTraj = TrajectoryGenerator.generateTrajectory(
        ...
        List.of(new Translation2d(Units.inchesToMeters(210), Units.inchesToMeters(108))),
        // End end at the cube, facing forward
        balancePose,
        configBalance);
    ...
    addCommands(
        ...
        new MoveElbowThenShoulder(arm, Constants.ArmConstants.SAFE_POSITION, 1.5),
