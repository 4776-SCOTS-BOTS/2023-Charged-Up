...
public class BlueRightConeCube extends SequentialCommandGroup {
        ...
        public BlueRightConeCube(DriveSubsystem drive, Arm arm, Gripper gripper, Intake intake) {
                ...
                Trajectory driveToPlaceTraj = TrajectoryGenerator.generateTrajectory(
                                ...
                                List.of(
                                                new Translation2d(3.86, Units.inchesToMeters(30)),
                                                new Translation2d(2.2, Units.inchesToMeters(30))),
                                // End end at the cube, facing forward
                                scoringPose,
                                configRev);
                ...
                addCommands(
                                ...
                                new ParallelCommandGroup(
                                                ...
                                                new MultiStepArm(arm, ArmConstants.CUBE_HIGH_POSITION,
                                                                ArmConstants.CUBE_HIGH_POSITION)),
                                ...
                                arm.setArmPositionCommand(
                                                new ArmPosition(ArmConstants.CUBE_HIGH_POSITION.elbowDegrees - 30,
