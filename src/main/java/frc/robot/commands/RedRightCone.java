...
public class RedRightCone extends SequentialCommandGroup {
    /** Creates a new CubeAndLeaveAuto. */
    public RedRightCone(DriveSubsystem drive, Arm arm, Gripper gripper, Intake intake) {
        //Field width = 315.5in
        ...
        RectangularRegionConstraint bumpConstraint = new RectangularRegionConstraint(new Translation2d(3.295, Units.inchesToMeters(256)),
