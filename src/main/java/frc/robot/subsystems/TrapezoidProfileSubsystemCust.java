 ...
 */
public abstract class TrapezoidProfileSubsystemCust extends SubsystemBase {
   ...
   */
  public TrapezoidProfileSubsystemCust(
   ...
   * @param constraints The constraints (maximum velocity and acceleration) for the profiles.
   */
  public TrapezoidProfileSubsystemCust(TrapezoidProfile.Constraints constraints) {
